# Модуль А (Аудит)
Представленная информация может отличатся от самого задания
...
Команды чтобы узнать характеристики устройств на Windows | Linux | Routers | Swiths 

На Linux

Узнать информацию о процессоре и памяти:
```
cat /proc/cpuinfo
cat /proc/meminfo
```
...
ifconfig -a
```
Узнать информацию о жестких дисках:
```
df -h
```
Узнать информацию о загрузке системы:
...
Узнать информацию о процессоре, памяти и системе:
```
systeminfo
```
Узнать информацию о сетевых интерфейсах
...
Узнать информацию о интерфейсах и маршрутизации:
```
show ip interface brief
show ip route
```
Узнать информацию о VLAN и портах:
```
show vlan
show interfaces status
```
Узнать информацию о сетевых соединениях:
```
...
![image](https://github.com/stepanovs2005/Professions-2024-/assets/163839573/8ead2fdf-c948-4c09-95ba-c20b15943591)

![image](https://github.com/stepanovs2005/Professions-2024-/assets/163839573/9eb84912-3f7e-4c50-98ce-49408de0f749)

![image](https://github.com/stepanovs2005/Professions-2024-/assets/163839573/b64db27e-43b3-4f5f-a40a-11aa88b418e2)



Примеры физической топологии:

![image](https://github.com/stepanovs2005/Professions-2024-/assets/163839573/88d9d8e2-aabf-4293-97c6-b5226e7ef3fd)

![image](https://github.com/stepanovs2005/Professions-2024-/assets/163839573/95a2d73e-d975-4970-8070-44be254bee9c)

![image](https://github.com/stepanovs2005/Professions-2024-/assets/163839573/baedcf50-7d20-41da-9fc9-b75e778f7756)

![image](https://github.com/stepanovs2005/Professions-2024-/assets/163839573/37057db6-8110-40a3-b4d5-47a410ba0a74)
...
licence-manager
```
Для подключения к ELM укажите ваш serial-number и licence-key
Задайте серийный номер.
```
